  ...
  public: {
    Tables: {
      store_colors: {
        ...
        Relationships: [
          {
            foreignKeyName: "store_colors_store_id_fkey"
            columns: ["store_id"]
            isOneToOne: false
      ...
      store_grades: {
        ...
        Relationships: [
          {
            foreignKeyName: "store_grades_store_id_fkey"
            columns: ["store_id"]
            isOneToOne: false
            referencedRelation: "stores"
            referencedColumns: ["id"]
      ...
      ai_provider_settings: {
        Row: {
          anthropic_config: Json | null;
          created_at: string | null;
          custom_ai_config: Json | null;
      ...
      product_grade_models: {
        ...
        Relationships: [
          {
            foreignKeyName: "product_grade_models_product_id_fkey";
            columns: ["product_id"];
            isOneToOne: false;
            referencedRelation: "products";
            referencedColumns: ["id"];
      ...
      products: {
        Row: {
          ...
          depth: number | null;
          description: string | null;
          enable_gradual_wholesale: boolean | null;
      ...
      store_order_bump_configs: {
        ...
        Relationships: [
          {
            foreignKeyName: "store_order_bump_configs_store_id_fkey";
            columns: ["store_id"];
            isOneToOne: false;
            referencedRelation: "stores";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "store_order_bump_configs_product_id_fkey";
            columns: ["product_id"];
            isOneToOne: false;
            referencedRelation: "products";
            referencedColumns: ["id"];
    ...
    Functions: {
      ...
      get_benefit_limit: {
        Args: { _benefit_key: string; _store_id: string };
        Returns: string;
      };
      get_feature_limit: {
        Args: {
    ...
    Enums: {
      business_hours_display: "summary" | "detailed";
      ...
      | "cash"
      | "crypto";
      shipping_method_type: "pickup" | "delivery" | "correios" | "custom";
