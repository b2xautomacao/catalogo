                             ...
                             <div className="flex-1 flex items-center justify-between ml-4">
                                ...
                                <div className="flex items-center gap-4 mr-2">
                                   ...
                                   <div className="flex flex-col items-center">
                                      ...
                                      {v.is_grade ? (
                                        /* ── GRADE: campo grade_price dedicado, sempre editável ── */
                                        <div className="relative">
                                          ...
                                          <Input
                                            ...
                                            value={v.grade_price ?? (
                                              formData.retail_price > 0
                                                ? Math.max(0, (formData.retail_price + (v.price_adjustment || 0)) * ((formData.wholesale_price || formData.retail_price) / formData.retail_price))
                                          ...
                                          />
                                          {/* Amostragem: preço por par */}
                                          {v.grade_quantity && v.grade_quantity > 0 && (
                                            <div className="text-[7px] text-center text-emerald-600 font-bold -mt-0.5">
                                              R$ {((v.grade_price || formData.wholesale_price || 0) / v.grade_quantity).toFixed(2)} / par
                                            </div>
                                          )}
                                        </div>
                                      ) : formData.retail_price > 0 ? (
                                        /* ── VARIAÇÃO SIMPLES com retail_price: calculado proporcionalmente ── */
                                        ...
                                        /* ── VARIAÇÃO SIMPLES atacado-only: editar price_adjustment ── */
                                        <div className="relative">
                                          <span className="absolute left-1 top-1/2 -translate-y-1/2 text-[8px] font-bold text-emerald-500">R$</span>
                                          <Input
                                            type="number"
